...
import org.org.eclipse.core.utils.platform.jobs.completion.SwtUtil.FadeJob;
import org.org.eclipse.core.utils.platform.jobs.completion.SwtUtil.IFadeListener;
 ...
 * @author Pierre-Antoine Grégoire FIXME once available in a standard distribution, and move to this distribution is mainstream, remove this borrowed code if possible.
 */
public abstract class AbstractNotificationPopup extends Window {
	...
	protected void createTitleArea(Composite parent) {
		...
		if (getPopupShellImage(TITLE_HEIGHT) != null) {
		...
		button.setImage(PlatformUtilsPlugin.getDefault().getImages().getImage(PluginImages.ICON_REMOVE_ON_16));
