...
public class InsertNodeInXmlFileFromFileSystemJob extends Job {
	private static String JOB_ID = "CheatSheet helper: insert node in xml file in filesystem";
	private final String targetXPath;
	private final URL nodeDefinitionUrl;
	private final String targetFile;

	public InsertNodeInXmlFileFromFileSystemJob(String targetXPath, URL nodeDefinitionUrl, String targetFile) {
		super(JOB_ID);
	...
	private void generateFile(IProgressMonitor monitor) throws IOException, XPathExpressionException, TransformerFactoryConfigurationError, TransformerException, URISyntaxException {
		...
		XmlToolBox.xPathInsertNode(targetXPath, nodeDefinition.toString(), inputStream, outputStream);
	}
	...
	private StringBuilder readNodeDefinition() throws IOException, URISyntaxException {
		StringBuilder nodeDefinition = new StringBuilder();
		InputStream nodeDefinitionInputStream = null;
		try {
