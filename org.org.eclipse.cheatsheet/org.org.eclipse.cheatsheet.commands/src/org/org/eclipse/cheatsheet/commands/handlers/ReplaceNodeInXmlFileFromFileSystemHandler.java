...
import org.org.eclipse.cheatsheet.commands.internal.jobs.ReplaceNodeInXmlFileFromFileSystemJob;
 ...
 */
public class ReplaceNodeInXmlFileFromFileSystemHandler extends AbstractExtendedHandler<Object> {
	private static final String COMMAND_ID = "org.org.eclipse.cheatsheet.commands.replaceNodeInXmlFileFromFileSystemCommand";
	 ...
	 * The constructor.
	 */
	public ReplaceNodeInXmlFileFromFileSystemHandler() {
	}
	...
	private void launchJob(String targetXPath, URL nodeDefinitionUrl, String targetFile) {
		Job job = new ReplaceNodeInXmlFileFromFileSystemJob(targetXPath, nodeDefinitionUrl, targetFile);
