...
public class CheatSheetUrlReferenceDialog extends AbstractInputTrayDialog {
	...
	public CheatSheetUrlReferenceDialog(Shell shell) {
	...
	protected Control createDialogArea(Composite parent) {
		...
		createTextField(composite, urlHolder, "Url");
