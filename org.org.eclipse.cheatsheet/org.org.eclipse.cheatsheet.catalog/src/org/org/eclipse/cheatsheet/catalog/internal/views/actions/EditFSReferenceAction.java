...
import org.org.eclipse.cheatsheet.catalog.internal.views.actions.enabling.EnabledForWritableFSCheatSheetReferenceAction;
...
public class EditFSReferenceAction extends EnabledForWritableFSCheatSheetReferenceAction {
	/**
	 * 
	 */
	private final CheatSheetCatalogView cheatSheetCatalogView;

	public EditFSReferenceAction(CheatSheetCatalogView cheatSheetCatalogView, CheatSheetCatalogView actionHost) {
		super(actionHost);
	...
	public void run() {
		...
		if (inputDialog.open() == Window.OK) {
			reference = new CheatSheetReference(CheatSheetReferenceType.FILE_SYSTEM, inputDialog.getId(), inputDialog.getName(), inputDialog.getUrl(), new Tags(inputDialog.getTags()));
