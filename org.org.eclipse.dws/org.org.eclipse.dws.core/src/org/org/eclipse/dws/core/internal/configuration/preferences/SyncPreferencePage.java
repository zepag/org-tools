...
public class SyncPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	/**
	 * Instantiates a new advanced preference page.
	 */
	public SyncPreferencePage() {
		super(GRID);
		setImageDescriptor(DWSCorePlugin.getDefault().getImages().getImageDescriptor(PluginImages.LOGO_MAVEN_SYNCHRONIZE_16));
