...
import org.org.eclipse.dws.core.internal.handlers.ImportRepositoryFromUrlHandler;


/**
 * The Class ImportRepositoryFromUrlAction.
 * 
 * @author pagregoire
 */
public class ImportRepositoryFromUrlAction extends AbstractSimpleAction {
	...
	/**
	 * Instantiates a new import repository from url action.
	 * 
	 * @param actionHost the action host
	 */
	public ImportRepositoryFromUrlAction(IActionHost actionHost) {
	...
	@Override
	public void run() {
		ImportRepositoryFromUrlHandler importRepositoryFromUrlHandler = new ImportRepositoryFromUrlHandler();
		try {
			importRepositoryFromUrlHandler.execute(new ExecutionEvent());
