...
/**
 * The Class EditRepositoryAction.
 * 
 * @author pagregoire
 */
public class EditRepositoryAction extends AbstractSimpleAction {
	...
	/**
	 * Instantiates a new edits the repository action.
	 * 
	 * @param actionHost the action host
	 */
	public EditRepositoryAction(IActionHost actionHost) {
	...
	public void run() {
		...
		if (next instanceof CrawledRepository) {
			EditRepositoryWizard newRepositoryWizard = new EditRepositoryWizard((CrawledRepository) next);
