...
public class ErrorDialog extends org.org.eclipse.core.utils.platform.dialogs.message.ErrorDialog {
	...
	public ErrorDialog(Shell parentShell, Image image, String subTitle, String dialogMessage, Object detail) {
		...
		setImage(BasePlugin.getDefault().getImages().getImage(PluginImages.LOGO_ORG_ERROR_64));
	}
