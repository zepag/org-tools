...
public abstract class EnabledForCheatSheetReferenceAction extends ResolvedAction<CheatSheetCatalogView> {

	public EnabledForCheatSheetReferenceAction(CheatSheetCatalogView actionHost) {
		super(actionHost);
	}
