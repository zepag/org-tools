...
public abstract class EnabledForCheatSheetCatalogAction extends ResolvedAction<CheatSheetCatalogView> {

	public EnabledForCheatSheetCatalogAction(CheatSheetCatalogView actionHost) {
		super(actionHost);
	}
