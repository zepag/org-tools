...
public abstract class CatalogAwareFieldsValidator implements IFieldsValidator {
	private CheatSheetCatalog catalog;

	public CatalogAwareFieldsValidator(CheatSheetCatalog catalog) {
		super();
		this.catalog = catalog;
	}

	public CheatSheetCatalog getCatalog() {
		return catalog;
	}
}