...
/**
 * Borrowed from Mylyn core. Helper Class to create the colors for the {@link AbstractNotificationPopup}.
 * <p>
...
public class NotificationPopupColors {
	...
	private void createColors() {
		...
		titleText = getColor(resourceManager, getSystemColor(SWT.COLOR_INFO_FOREGROUND));
	}
