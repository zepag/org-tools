...
public class ErrorDialog extends AbstractInformationDialog {
    ...
    public ErrorDialog(String subTitle, String dialogMessage) {
        this(PlatformUtilsPlugin.getActiveShell(),PlatformUtilsPlugin.getDefault().getImages().getImage(PluginImages.LOGO_BASIC_ERROR_64), subTitle, dialogMessage);
    }
    ...
    public ErrorDialog(String subTitle, String dialogMessage, Object detail) {
    	this(PlatformUtilsPlugin.getActiveShell(),PlatformUtilsPlugin.getDefault().getImages().getImage(PluginImages.LOGO_BASIC_ERROR_64), subTitle, dialogMessage,detail);
    }
    /**
    ...
    public ErrorDialog(Shell parentShell,Image image,String subTitle, String dialogMessage) {
        this(PlatformUtilsPlugin.getActiveShell(), Messages.ErrorDialog_title, subTitle, null, dialogMessage, null, new String[] { IDialogConstants.OK_LABEL }, 0, -1,image);
    }
    ...
    public ErrorDialog(Shell parentShell,Image image,String subTitle, String dialogMessage, Object detail) {
        this(PlatformUtilsPlugin.getActiveShell(), Messages.ErrorDialog_title, subTitle, null, dialogMessage, detail, new String[] { IDialogConstants.OK_LABEL, IDialogConstants.SHOW_DETAILS_LABEL }, 0, 1,image);
    }
    /**
     * @param parentShell
     * @param dialogTitle
