...
public class PlatformUtilsPlugin extends AbstractUIPlugin implements IStartup{
	...
	public PlatformUtilsPlugin() {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("org.org.eclipse.core.utils.platform.CorePluginResources");
...
//		DOMConfigurator.configure(PlatformUtilsPlugin.getFile("log4j.xml").toURI().toURL());
		...
		images.addImage(this, "icons/small_error_16.gif", PluginImages.SMALL_ERROR_16);
		images.addImage(this, "icons/small_warning_16.gif", PluginImages.SMALL_WARNING_16);
	...
	public static String getResourceString(String key) {
		ResourceBundle bundle = PlatformUtilsPlugin.getDefault().getResourceBundle();
		try {
