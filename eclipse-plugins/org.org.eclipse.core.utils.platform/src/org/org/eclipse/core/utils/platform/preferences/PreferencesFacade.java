...
public class PreferencesFacade {
	...
	public static Object getPreference(AbstractUIPlugin plugin, String propertyName, Class<?> type) {
		...
		if (type.equals(Boolean.class)) {
			result = Boolean.valueOf(plugin.getPreferenceStore().getBoolean(propertyName));
		}
		if (type.equals(Integer.class)) {
			result = Integer.valueOf(plugin.getPreferenceStore().getInt(propertyName));
		}
		...
		if (type.equals(Long.class)) {
			result = Long.valueOf(plugin.getPreferenceStore().getLong(propertyName));
		}
		return result;
	}
