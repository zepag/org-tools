 ...
 * @author pagregoire
 */
public class AddTargetToLibraryPackArtifactVersionAction extends AbstractDWSViewAction {
	 ...
	 *            the action host
	 */
	public AddTargetToLibraryPackArtifactVersionAction(Target target, IActionHost actionHost) {
		super(actionHost);
		this.target = target;
	}
