...
import org.org.eclipse.dws.ui.internal.handlers.OpenMavenRepositoryViewHandler;

/**
 * The Class OpenMavenRepositoryViewAction.
 */
public class OpenMavenRepositoryViewAction extends AbstractWorkbenchWindowAction {

	/** The Constant ACTION_LABEL_ID. */
	public static final String ACTION_LABEL_ID = ActionsMessages.OpenMavenRepositoryViewAction_id;
	...
	public void run(IAction action) {
		run(new Runnable() {
			public void run() {
				...
				OpenMavenRepositoryViewHandler openMavenRepositoryViewHandler = new OpenMavenRepositoryViewHandler();
				try {
					openMavenRepositoryViewHandler.execute(new ExecutionEvent(null, Collections.EMPTY_MAP, null, handlerService.getCurrentState()));
				} catch (ExecutionException e) {
					ErrorDialog errorDialog = new ErrorDialog(ACTION_LABEL_ID, "Problem while trying to open maven repositories view", e);
					errorDialog.open();
				}
			}
