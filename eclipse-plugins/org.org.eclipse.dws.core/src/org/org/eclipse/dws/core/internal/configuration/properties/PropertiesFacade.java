...
public class PropertiesFacade {
	 ...
	 */
	public static Object getProjectProperty(IProject project, String propertyName, boolean failIfNull) {
	...
	public static void loadProperties(IProject project) {
		Map map = PropertiesPersistenceFile.loadProperties(project);
		try {
			if (map == null) {
